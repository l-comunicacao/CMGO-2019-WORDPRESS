...
<div class="w-section city-guide-content">
	<div class="container overflow">
		<div class="row">
			<div class="col-12 col-md">
				<div class="city-guide-column active" data="5">
			...
			<div class="col-12 col-md">
				<div class="city-guide-column" data="2">
	...
	<!-- Bloco Passeios -->
	<div class="container container-items" data="4">
		<?php get_template_part( 'includes/guia-passeios' ); ?>
		<br>
	</div>

	<!-- Pacotes de turismo -->
	<div class="container container-items active" data="5">
